...
<body>
    ...
    <section class="contenedor-producto">
        ...
        <div class="info-producto">
            ...
            <h1 class="titulo-producto">PERRO EN COMBO</h1>
            <p class="precio-producto">$7.99</p>

            <p class="descripcion">
                Perro caliente estilo gourmet acompañado de papas y bebida. Perfecto para una comida rápida, completa y deliciosa.
            </p>
